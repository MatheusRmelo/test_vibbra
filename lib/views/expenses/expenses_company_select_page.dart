...
class ExpensesCompanySelectPage extends StatefulWidget {
  const ExpensesCompanySelectPage({super.key});

  @override
  State<ExpensesCompanySelectPage> createState() =>
      _ExpensesCompanySelectPageState();
}

class _ExpensesCompanySelectPageState extends State<ExpensesCompanySelectPage> {
  String _search = "";
